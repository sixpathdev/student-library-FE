...
//   };
  ...
  fileselected = () => {
    ...
    //main file
    const userPhoto = this.fileinput.current.files[0]
    ...
    return (
      <>
        ...
        <div className="flex flex-no-wrap">
          <Sidebar />
          <div className="flex flex-wrap justify-around mt-10 md:mt-20 pb-8">
            <div className="w-full md:w-1/4 mx-auto">
              <img
                ...
                alt="userphoto"
              />
              <div className="text-center mt-3 text-2xl text-gray-800">
                John Doe
              </div>
              <span
                style={{
            ...
            <div className="w-5/6 md:w-2/4 mx-0 md:ml-auto">
              <form className="bg-white shadow-md rounded px-5 md:px-8 pt-4 md:pt-6 pb-6 mb-4">
                <div className="mb-4">
                  <label
                ...
                <div className="w-full">
                  <button
                    className="w-full bg-blue-500 hover:bg-blue-700 text-white sm:text-sm font-bold py-2 px-10 rounded focus:outline-none focus:shadow-outline"
                    type="button"
                  >
                    Update Details
                  </button>
